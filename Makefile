...
LDFLAGS		=	-L $(SRV_DIR)/lib/mysql -L $(LIB_CRPT)/libcryptopp.a -lmysqlclient -lcryptopp -lpthread -lm -lrt -ldl -L $(FMOD_DIR)/lib -Wl,--rpath=$(FMOD_DIR)/lib -lfmodex64

CPPFLAGS	=	-Wno-overflow #-Wall -Wextra
